...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ChaseWebServicesFinalProject.Android.dll" comes first in this list. */
		"ChaseWebServicesFinalProject.Android.dll",
		"ChaseWebServicesFinalProject.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
